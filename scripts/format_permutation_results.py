...
def format_markdown(
    ...
    lines.append(
        ...
        "source strides). Every backend allocates a fresh destination inside each "
        "timed call, so the table compares allocation-inclusive end-to-end "
        "materialization rather than destination-reuse copy kernels. "
