...
The standard GPU and GPU linalg AD formatters (`scripts/format_gpu_results.py`
and `scripts/format_gpu_linalg_ad_results.py`) link documented problem names to
these anchors when writing under this repository's `result/` directory. Missing notes or anchors leave the item unchanged; stdout and outputs
...
[NVIDIA small linalg AD](nvidia-gpu/gpu/linalg_ad_latency.md).
