...
test -s "$TMP/result/results-einsum.md"
...
grep -q "Strategy: opt_flops" "$TMP/result/results-einsum.md"
grep -q "PyTorch Python" "$TMP/result/results-einsum.md"
grep -q "Torch C++" "$TMP/result/results-einsum.md"
grep -q "Generated by \`./scripts/run_all.sh 1\`" "$TMP/result/results-einsum.md"
